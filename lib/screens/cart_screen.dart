...
import '../widgets/product_recommendation_widget.dart'; // Importar el nuevo widget
...
class CartScreen extends StatelessWidget {
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Subtotal: \$${cartItem.subtotal.toStringAsFixed(2)}'),
                                  ],
                                ),
                                trailing: SizedBox(
                                  width: 120,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            _showCheckoutDialog(context, cartProvider, apiService);
                          },
                          child: const Text(
                            'PROCEDER AL PAGO',
  ...
  void _showCheckoutDialog(BuildContext context, CartProvider cartProvider, ApiService apiService) {
    String tipoEnvio = 'domicilio';  // Valores por defecto
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                RadioListTile<String>(
                  title: const Text('Tarjeta de crédito/débito (Stripe)'),
                  value: 'tarjeta',
                  groupValue: formaPago,
                  onChanged: (value) {
                    setState(() {
          ...
          actions: [
            ...
            // Modificar en el _showCheckoutDialog del CartScreen
            ElevatedButton(
              child: const Text('Confirmar Compra'),
              onPressed: () async {
                // Crear la lista de detalles de orden
                final detalles = cartProvider.items.values.map((item) => 
                  OrdenDetalleItem(
                ...
                // Si el usuario eligió pago con tarjeta, ir a la pantalla de Stripe
                if (formaPago == 'tarjeta') {
                  Navigator.of(ctx).pop(); // Cerrar el diálogo de checkout
                ...
                // Para otros métodos de pago, continuar con el proceso original
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('¡Compra exitosa! Orden #$ordenId creada.'),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Error al procesar la compra: $error'),
